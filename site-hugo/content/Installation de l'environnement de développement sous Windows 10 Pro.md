...
![illustpng-dev.png]({{< ref "illustpng-dev.png" >}})
...
![illustpng-prod.png]({{< ref "illustpng-prod.png" >}})
...
![w10-msdwdfail.png]({{< ref "w10-msdwdfail.png" >}})
...
![newvm-vmware.png]({{< ref "newvm-vmware.png" >}})
...
![assistantonly-vmware.png]({{< ref "assistantonly-vmware.png" >}})
...
![assistantonly1-vmware.png]({{< ref "assistantonly1-vmware.png" >}})
...
![assistantonly2-vmware.png]({{< ref "assistantonly2-vmware.png" >}})
...
![assistantonlynaming-vmware.png]({{< ref "assistantonlynaming-vmware.png" >}})

![assistantonlynamingok-vmware.png]({{< ref "assistantonlynamingok-vmware.png" >}})

![429]({{< ref "hwsel28gig-vmware.png" >}})

![433]({{< ref "hwselquadcore-vmware.png" >}})

ORGANISER LES IMAGES

![assistantvdisksize-vmware.png]({{< ref "assistantvdisksize-vmware.png" >}})


![assistantresume-vmware.png]({{< ref "assistantresume-vmware.png" >}})
...
![bootkey-vmware.png]({{< ref "bootkey-vmware.png" >}})

>[!INFO]
>Si vous ne pressez pas la touche assez rapidement, l'ordinateur virtuel démarera dans le vide et pas sur l'image d'installation de Windows. Vous devez fermer la machine et la redémarrer. Pour cela, vous pouvez suivre cet article : [Redémarrer une machine virtuelle plantée]({{< ref "Redémarrer une machine virtuelle plantée" >}})

![efitimout-vmware.png]({{< ref "efitimout-vmware.png" >}})

L'ordinateur virtuel démare. 

![load-vmware.png]({{< ref "load-vmware.png" >}})

Si vous voyez l'icone de chargement, alors l'installateur de windows se lance. 

![loadw10-vmware.png]({{< ref "loadw10-vmware.png" >}})
...
![w10-install-now.png]({{< ref "w10-install-now.png" >}})

![w10-install-regionlg.png]({{< ref "w10-install-regionlg.png" >}})
...
![w10-install-productkey.png]({{< ref "w10-install-productkey.png" >}})

Sélectionnez la version Pro dans la liste déroulante

![w10-install-selprodpro.png]({{< ref "w10-install-selprodpro.png" >}})

Acceptez de nouveau les termes du contrat. 

![w10-install-acceptlic.png]({{< ref "w10-install-acceptlic.png" >}})

Cliquez sur installer uniquement Windows

![w10-install-onlyinst.png]({{< ref "w10-install-onlyinst.png" >}})

Maintenant, il faut sélectionner le disque virtuel que nous avons créé tout à l'heure. 
Suivant

![w10-install-seldrive.png]({{< ref "w10-install-seldrive.png" >}})

Maintenant, windows va s'installer. 

![w10-install-load.png]({{< ref "w10-install-load.png" >}})

Lorsque l'installation est (presque) terminée, l'ordinateur doit redémarrer. 

![w10-install-installrunreboot.png]({{< ref "w10-install-installrunreboot.png" >}})

Après son redémarrage, la machine va traverser plusieurs redémarrages.

![w10-install-installhw.png]({{< ref "w10-install-installhw.png" >}})

![w10-install-wait.png]({{< ref "w10-install-wait.png" >}})

Il faut à nouveau régler les paramètres régionnaux

![w10-install-regionlg2.png]({{< ref "w10-install-regionlg2.png" >}})

![w10-install-regionlg3.png]({{< ref "w10-install-regionlg3.png" >}})

Ignorer pour la deuxième disposition 

![w10-install-regionlg4.png]({{< ref "w10-install-regionlg4.png" >}})

![w10-install-net.png]({{< ref "w10-install-net.png" >}})

Cliquez sur "Configurer pour une organisation"

![w10-install-adjoinornot.png]({{< ref "w10-install-adjoinornot.png" >}})

Cliquez sur Joindre le domaine à la place

![w10-install-domainjoin.png]({{< ref "w10-install-domainjoin.png" >}})

Saisissez le nom d'utilisatueur de la machine virtuelle, ici mgmt-mediawiki

![w10-install-username.png]({{< ref "w10-install-username.png" >}})

Une série de demandes d'installation de programmes de service et publicitaires vous seront demandés. Ignorez les tous.

![w10-install-notedgesel.png]({{< ref "w10-install-notedgesel.png" >}})

![w10-install-noreg.png]({{< ref "w10-install-noreg.png" >}})

![w10-install-noloc.png]({{< ref "w10-install-noloc.png" >}})

![w10-install-onlytelem.png]({{< ref "w10-install-onlytelem.png" >}})

![w10-install-noman.png]({{< ref "w10-install-noman.png" >}})

![w10-install-ast.png]({{< ref "w10-install-ast.png" >}})

![w10-install-nopub.png]({{< ref "w10-install-nopub.png" >}})

![w10-install-noexp.png]({{< ref "w10-install-noexp.png" >}})

![w10-install-nocort.png]({{< ref "w10-install-nocort.png" >}})

Le système continue de s'installer.

![w10-install-load2.png]({{< ref "w10-install-load2.png" >}})

![w10-install-load3.png]({{< ref "w10-install-load3.png" >}})
...
![w10-install-loaded.png]({{< ref "w10-install-loaded.png" >}})
...
![w10-install-installed.png]({{< ref "w10-install-installed.png" >}})

Windows détecte le disque virtuel d'installation des additions. 

![w10-install-vmtoolsload.png]({{< ref "w10-install-vmtoolsload.png" >}})

Ouvrez l'explorateur de fichiers, puis naviguez dans le lecteur DVD. Cliquez dessus

![w10-install-vmtoolsexpl.png]({{< ref "w10-install-vmtoolsexpl.png" >}})

Un UAC (fenêtre d'autorisation) apparait, cliquez sur Oui

![w10-install-vmtoolsexpluacok.png]({{< ref "w10-install-vmtoolsexpluacok.png" >}})

La fenêtre d'installation apparait, cliquez sur suivant

![w10-install-vmtool2.png]({{< ref "w10-install-vmtool2.png" >}})

Choisissez l'installation complète 

![w10-install-vmtoolcompl.png]({{< ref "w10-install-vmtoolcompl.png" >}})

Cliquez sur Installer

![w10-install-vminst.png]({{< ref "w10-install-vminst.png" >}})

![w10-install-vminst2.png]({{< ref "w10-install-vminst2.png" >}})

L'installateur vous demande de redémarrer la machine virtuelle. Cliquez sur Oui

![w10-install-vminstreboot.png]({{< ref "w10-install-vminstreboot.png" >}})

La machine redémarre 

![w10-install-vminstreboot1.png]({{< ref "w10-install-vminstreboot1.png" >}})
...
![w10-edgeskip.png]({{< ref "w10-edgeskip.png" >}})

![w10-edgeskip1.png]({{< ref "w10-edgeskip1.png" >}})

![w10-edgeskip2.png]({{< ref "w10-edgeskip2.png" >}})

![w10-edgeskip3.png]({{< ref "w10-edgeskip3.png" >}})
...
![w10-wamprealsite.png]({{< ref "w10-wamprealsite.png" >}})
...
Cliquez sur Wampserver x.x.x, en dessous de "Last Wampserver full install version", pour télécharger wampserver. 
 ![w10-wampdwd.png]({{< ref "w10-wampdwd.png" >}})
...
![w10-deskcmddir3.png]({{< ref "w10-deskcmddir3.png" >}})

La commande s'exécute

![w10-deskcmdhashok.png]({{< ref "w10-deskcmdhashok.png" >}})

Ouvrez le bloc notes

![w10-blcnotes.png]({{< ref "w10-blcnotes.png" >}})

Collez le hash de tout à l'heure avec CTRL + V

![w10-blcnotes3.png]({{< ref "w10-blcnotes3.png" >}})

notez sa provenance

![w10-blcnotes4.png]({{< ref "w10-blcnotes4.png" >}})

reprenez le hash de l'invite de commande en le séléctionnant, puis en faisant CTRL + MAJ + C

![w10-blcnotes6.png]({{< ref "w10-blcnotes6.png" >}})

et collez le dans le bloc notes pour le comparer avec celui du site.

![w10-blcnotes7.png]({{< ref "w10-blcnotes7.png" >}})
...
![w10-blcnotes8.png]({{< ref "w10-blcnotes8.png" >}})
...
![w10-blcnotes9.png]({{< ref "w10-blcnotes9.png" >}})


![w10-blcnotes10.png]({{< ref "w10-blcnotes10.png" >}})

Si le code renvoie OK, nous pouvons passer à l'installation de WAMP

![w10-blcnotes10attentionresult.png]({{< ref "w10-blcnotes10attentionresult.png" >}})
...
![w10-wampscrolldown.png]({{< ref "w10-wampscrolldown.png" >}})
...
![w10-wampredist.png]({{< ref "w10-wampredist.png" >}})

![dwd-aio.png]({{< ref "dwd-aio.png" >}})

![dwd-aiodwd.png]({{< ref "dwd-aiodwd.png" >}})

Comme avec Wamp, il faut vérifier l'authenticité du fichier. Copiez le MD5

![dwd-aiodwdmd5.png]({{< ref "dwd-aiodwdmd5.png" >}})

Notez le dans le bloc notes

![dwd-aiodwdmd5redistblc.png]({{< ref "dwd-aiodwdmd5redistblc.png" >}})

ouvrez l'invite de commande 

![w10-cmdopen.png]({{< ref "w10-cmdopen.png" >}})
...
![w10-certutilruntime.png]({{< ref "w10-certutilruntime.png" >}})

```
certutil -hashfile Visual-C-Runtimes-All-in-One-xx-xx.zip
```

![w10-certutilruntime3.png]({{< ref "w10-certutilruntime3.png" >}})

```
if "le hash site" == "le hash certutil" (echo OK)
```

![w10-certutilsha1purée.png]({{< ref "w10-certutilsha1purée.png" >}})
...
![w10-extract.png]({{< ref "w10-extract.png" >}})

Cliquez sur extraire
![w10-extract2.png]({{< ref "w10-extract2.png" >}})
...
![w10-batchinstall.png]({{< ref "w10-batchinstall.png" >}})

Cliquez sur Exécuter

![w10-batchinstalladmex.png]({{< ref "w10-batchinstalladmex.png" >}})

Pensez a cliquer sur oui a chaque prompt UAC 

![w10-batchinstalladmexuac.png]({{< ref "w10-batchinstalladmexuac.png" >}})


L'installation progressra sous forme de plusieurs installations.


![loadred.png]({{< ref "loadred.png" >}})

On peut à présent ouvrir l'installateur de Wamp

![w10-wampinstall.png]({{< ref "w10-wampinstall.png" >}})

en prenant soin de dire oui à l'UAC

![w10-wampinstalluac.png]({{< ref "w10-wampinstalluac.png" >}})

Sélectionnez la langue

![w10-wampinstalllang.png]({{< ref "w10-wampinstalllang.png" >}})

Accepter la licence

![w10-wampinstallic.png]({{< ref "w10-wampinstallic.png" >}})

Nous avons installer les redist, donc suivant

![w10-wampinstallredistwarn.png]({{< ref "w10-wampinstallredistwarn.png" >}})

Garder le chemin racine de Wamp

![w10-wampinstallrootc.png]({{< ref "w10-wampinstallrootc.png" >}})

Chargement

![w10-wampinstallrootc5.png]({{< ref "w10-wampinstallrootc5.png" >}})

Choisir les applications par défaut, en mettant tout sur oui. 

![w10-wampinstallrootc7.png]({{< ref "w10-wampinstallrootc7.png" >}})
Suivant
![w10-wampinstallinf.png]({{< ref "w10-wampinstallinf.png" >}})

Installation terminée, cliquez sur terminer

![w10-wampinstallend.png]({{< ref "w10-wampinstallend.png" >}})

Avec l'explorateur de fichiers, naviguez dans le disque local C:

![w10-wamproot.png]({{< ref "w10-wamproot.png" >}})

Rendez vous dans wamp64

![w10-wampwww.png]({{< ref "w10-wampwww.png" >}})
...
![w10-wampbase.png]({{< ref "w10-wampbase.png" >}})
...
![w10-mediawikisrc.png]({{< ref "w10-mediawikisrc.png" >}})

![w10-mediawikisrc2.png]({{< ref "w10-mediawikisrc2.png" >}})

![w10-mediawikisrc4.png]({{< ref "w10-mediawikisrc4.png" >}})

![w10-mediawikisrc5.png]({{< ref "w10-mediawikisrc5.png" >}})

![w10-mediawikisrc6.png]({{< ref "w10-mediawikisrc6.png" >}})

Télécharger la signature pour vérification !
A COMPLETER

![w10-mediawikisrc7gz.png]({{< ref "w10-mediawikisrc7gz.png" >}})

Après avoir verifié l'image, extraire son contenu en cliquant droit, puis extraire tout

![w10-mediawikisrcextract.png]({{< ref "w10-mediawikisrcextract.png" >}})

Cette opération peut prendre un certain temps

![w10-mediawikisrcextract2.png]({{< ref "w10-mediawikisrcextract2.png" >}})

![w10-mediawikisrcextract6.png]({{< ref "w10-mediawikisrcextract6.png" >}})

une fois extrait, la fenetre s'ouvre

![w10-mediawikisrcextract12.png]({{< ref "w10-mediawikisrcextract12.png" >}})
