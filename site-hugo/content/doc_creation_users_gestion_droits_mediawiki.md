...
<mark> Gestion des utilisateurs </mark>

* [Créer un compte utilisateur]({{< ref "Spécial:Créer_un_compte" >}})
* [Liste des utilisateurs]({{< ref "Spécial:Liste_des_utilisateurs" >}})
* [Gérer les droits utilisateurs]({{< ref "Special:UserRights" >}})
* [Bloquer un utilisateur]({{< ref "Special:Block" >}})

<mark> Gestion du contenu </mark>

* [Pages spéciales]({{< ref "Spécial:Pages_spéciales" >}})
* [Toutes les pages]({{< ref "Spécial:Toutes_les_pages" >}})
* [Modifications récentes]({{< ref "Spécial:Modifications_récentes" >}})
* [Pages demandées]({{< ref "Spécial:Pages_demandées" >}})
* [Pages orphelines]({{< ref "Spécial:Pages_orphelines" >}})
