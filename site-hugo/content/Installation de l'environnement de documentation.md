...
[Gestion de la documentation DSI avec Quartz et Markdown]({{< ref "Gestion de la documentation DSI avec Quartz et Markdown" >}})
...
![2. googlesearch-seldebian.png]({{< ref "2. googlesearch-seldebian.png" >}})
...
![3. dwdmain-debian.png]({{< ref "3. dwdmain-debian.png" >}})
...
![7. sha-lookup.png]({{< ref "7. sha-lookup.png" >}})
On ouvre donc un éditeur de texte et on copie colle dedans.

![542]({{< ref "8. note-sha.png" >}})
...
![10. shasum-man.png]({{< ref "10. shasum-man.png" >}})Le grimoire s'ouvre !
...
![11. shasum-man2.png]({{< ref "11. shasum-man2.png" >}})
...
![12. shasum-complete.png]({{< ref "12. shasum-complete.png" >}})
...
![13. shasum-result.png]({{< ref "13. shasum-result.png" >}})
...
On assigne d'abord un nom à la machine virtuelle, ici ![22. isosel.png]({{< ref "22. isosel.png" >}})


![17. createct-name.png]({{< ref "17. createct-name.png" >}})
...
![29. MANUALIP.png]({{< ref "29. MANUALIP.png" >}})
On peut à présent donner un nom à la machine.
![30. hostname.png]({{< ref "30. hostname.png" >}})
...
![35. flyingsaucer91300 - defroot.png]({{< ref "35. flyingsaucer91300 - defroot.png" >}})
...
![43. france.png]({{< ref "43. france.png" >}})
![44. archive mirror.png]({{< ref "44. archive mirror.png" >}})
...
![46. Packets.png]({{< ref "46. Packets.png" >}})
...
![50. Console Deb Login.png]({{< ref "50. Console Deb Login.png" >}})
...
![53. SSH fingerprint.png]({{< ref "53. SSH fingerprint.png" >}})
...
![54. Connected SSH.png]({{< ref "54. Connected SSH.png" >}})
...
![56. Hugo PKT.png]({{< ref "56. Hugo PKT.png" >}})
...
![57. Hugo PKT2.png]({{< ref "57. Hugo PKT2.png" >}})
...
![58. Obsidian éditeur.png]({{< ref "58. Obsidian éditeur.png" >}})
On a donc réorganisé la structure du répertoire pour matcher avec les exigences du moteur de rendu. 

![59. Obsidian remake.png]({{< ref "59. Obsidian remake.png" >}})

FINALEMENT, on a décidé de conserver notre structure, mais de séparer notre espace d'édition avec l'espace d'hugo.

![60. Remake2.png]({{< ref "60. Remake2.png" >}})

Nous avons une nouvelle contrainte. Il faut que hugo puisse lire les titres, les chemins vers les images. Et vous savez quoi ? Ce n'est pas le meme format que nous utilisons sur obsidian, par exemple pour faire le lien avec les images. Ca ressemble étrangement à du wikicode. 
...
[anssi-guide-authentification_multifacteur_et_mots_de_passe.pdf]({{< ref "anssi-guide-authentification_multifacteur_et_mots_de_passe.pdf" >}})
...
En tapant openssl, on retrouve les algos dispo. ![32. OpenSSL.png]({{< ref "32. OpenSSL.png" >}})
Tout cela en utilisant une combinaison aléatoire
![33. OpenSSL2.png]({{< ref "33. OpenSSL2.png" >}})
```
...
![34. OpenSSL3.png]({{< ref "34. OpenSSL3.png" >}})
